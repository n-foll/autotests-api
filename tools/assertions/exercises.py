...
def assert_get_exercise_response(
    ...
    :param actual_response: Ответ API при запросе задания.
    :param expected_response: Ответ API при создании задания.
    :raises AssertionError: Если данные задания не совпадают
    """
    assert actual_response.exercise is not None
    assert expected_response.exercise is not None
